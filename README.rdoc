...
* In many cron implementations entries which specify the day of the month and day of the week (i.e. "0 0 11 1,5 * mon") have a special meaning, this is not supported.
